...
################# Align by sample ID #########################
#Ensure both datasets are aligned sample IDs
valid_samples = prediction_data['Unnamed: 0']

# Align RNA data and prediction data by the sample IDs 
...
X = rna_data_filtered.T  # Transpose, samples rows genes columns
y = prediction_data_filtered['msi_status']  # Target variable msi status
######################################################################################
...
############################# Standardize and scale data (for logisitic regression) ############################
